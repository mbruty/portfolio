        ...
        <div class="taskbar">
          <div class="icons">
            <div class="icons-left">
              <a id="start-menu" onClick={this.toggleStartModal}>
                <i class="material-icons noselect clickthrough">widgets</i>
              </a>
              <div className="search">
                <input
                  type="text"
                  placeholder="Type here to search (project name | langauge)"
                  onFocus={this.toggleSearchModal}
                  onChange={this.toggleSearchModal}
                />
                ...
                if (element.showChrome || element.minimized) {
                  return (
                    <a
                      ...
                      id={element.windowToShow}
                      onClick={this.props.unMinimize}
                    >
                      {console.log(element)}
                      <i className={element.iconClass}>{element.icon}</i>
                    </a>
                  );
                } else return null;
              })}
