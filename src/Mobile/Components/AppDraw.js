            ...
            return (
                <div className="app-draw">
                    <div className="input-container">
                        <input ref={this.textRef} type="text" placeholder="Search apps, languages and more..." onBlur={this.unFocus} onChange={this.onChange}></input>
                    </div>
                    <div className="app-container">
                        {this.projects.map(project => {
                            if(project.name.toLowerCase().includes(this.state.search) || project.language.toLowerCase().includes(this.state.search)){
                                return (
                                    <div id={project.name} className="search-entry noselect" onClick={this.props.showWindow}>
                ...
                <div className="app-draw">
                    ...
                    <div className="app-container">
                        {this.projects.map(project => (
                            ...
                            project.name === "Recursion Example" || project.name === "Documents"? null :
